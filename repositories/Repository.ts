import { FilterQuery, Model, ObjectId, QueryOptions, SaveOptions, UpdateQuery, UpdateWithAggregationPipeline } from 'mongoose';
...
export class Repository<T extends Document>
{
    ...
    async insert(doc: object, saveOptions?: SaveOptions) : Promise<CreatedModel>
    {
    ...
    async delete(filter: FilterQuery<T>) : Promise<RemovedModel>
    {
